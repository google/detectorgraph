...
#define DETECTORGRAPH_CONFIG_LITE
// #define DETECTORGRAPH_CONFIG_VANILLLA

namespace DetectorGraph
{
/**
 * @brief _Internal_ - Provides an input queue of GraphInputDispatchers
 */
#if defined(DETECTORGRAPH_CONFIG_VANILLLA)
...
#elif defined(DETECTORGRAPH_CONFIG_LITE)
